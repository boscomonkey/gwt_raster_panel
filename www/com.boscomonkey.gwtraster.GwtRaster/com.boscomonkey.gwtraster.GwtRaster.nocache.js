function com_boscomonkey_gwtraster_GwtRaster(){
  ...
  if (isHostedMode()) {
    ...
    try {
      unflattenKeylistIntoAnswers(['gecko1_8'], 'EF96C15616139CCCCE23E11F7C6D419C.cache.html');
      unflattenKeylistIntoAnswers(['opera'], 'DF9B566C715E79E47C074063F01B7F9D.cache.html');
      unflattenKeylistIntoAnswers(['ie6'], 'BFF6E1F7F6CA12314312716976B50F42.cache.html');
      unflattenKeylistIntoAnswers(['safari'], 'AECF36D10B2AD9DDD54E8AC66CC1CA21.cache.html');
      unflattenKeylistIntoAnswers(['gecko'], '503A4BC91CEEBA59A4D538C15CFACCE2.cache.html');
